...
#### 인덱스와 도큐먼트
  ...
  ```
    ...
    동일한 인덱스에 있는 도큐먼트는 동일한 스키마를 갖는다.ㅋ
...
<img width="1681" alt="스크린샷 2023-08-05 오전 10 58 32" src="https://github.com/pnci1029/TIL/assets/81909140/31d56259-e244-4218-8ad2-55d6cfcc7766">
...
`키바나 대시보드`
  - <img width="1706" alt="스크린샷 2023-09-16 오후 3 33 30" src="https://github.com/pnci1029/TIL/assets/81909140/e7dc48b6-f42b-46f7-b927-18d57fe11c90">
```
  시각화한 데이터들을 인덱스 패턴에 맞춰 사용
```
